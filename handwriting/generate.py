...
def generate(args_text, args, sess, translation, text_color=[0, 0, 0]):
    ...
    if args.style is not None:
        style = None
        with open(os.path.join('handwriting/data', 'styles.pkl'), 'rb') as file:
    ...
    print('\nGenerating PDF...', end='')
    from PIL import Image
    img1 = Image.open('handwriting/pages/page1.jpg')
    im_list = [Image.open('handwriting/pages/page{}.jpg'.format(i)) for i in range(2, curr_page + 1)]
